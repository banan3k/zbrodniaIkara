const resources = {
  'image': [
		[ 'background', 'img/assets/bg.png' ],
		[ 'title', 'img/assets/logo.png' ],
    [ 'kolumna', 'img/assets/kolumna.png' ],
    [ 'ikar', 'img/assets/ikar.png' ],
		[ 'logo-pigames', 'img/logo-pigames.png' ],
		[ 'overlay', 'img/ui/overlay.png' ],
    [ 'pasekPostepu1', 'img/ui/pasek_postepu0.png' ],
    [ 'pasekPostepu2', 'img/ui/pasek_postepu1.png' ],
    [ 'pasekPredkosci1', 'img/ui/pasek_predkosci0.png' ],
    [ 'pasekPredkosci2', 'img/ui/pasek_predkosci1.png' ],
  ...
  'audio': [
		...
		[ 'audio-theme', [ 'sfx/game_greek.m4a', 'sfx/game_greek.mp3', 'sfx/game_greek.ogg' ] ],
  ],
};
