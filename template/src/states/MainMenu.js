...
export default class MainMenu extends Phaser.State {
  create() {
	...
	// GAME NAME / LOGO GOES HERE
     const title = this.add.sprite( this.world.width * 0.5, ( this.world.height - 100 ) * 0.5, 'title' );
     title.anchor.set( 0.5 );
  //  const logoText = new Text( this.game, 'center', ( this.world.height - 100 ) * 0.5, 'GAME NAME', MENU_HIGHSCORE_FONT, [ null, 1 ] );
  //  logoText.padding.set( 0, 15 );
